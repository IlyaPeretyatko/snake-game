  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        me.ippolitov.fit.snakes.SnakesProto.GameAnnouncement parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (me.ippolitov.fit.snakes.SnakesProto.GameAnnouncement) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 98: {
              me.ippolitov.fit.snakes.SnakesProto.GameMessage.DiscoverMsg.Builder subBuilder = null;
              if (typeCase_ == 12) {
                subBuilder = ((me.ippolitov.fit.snakes.SnakesProto.GameMessage.DiscoverMsg) type_).toBuilder();
              }
              type_ =
                  input.readMessage(me.ippolitov.fit.snakes.SnakesProto.GameMessage.DiscoverMsg.PARSER, extensionRegistry);
              if (subBuilder != null) {
                subBuilder.mergeFrom((me.ippolitov.fit.snakes.SnakesProto.GameMessage.DiscoverMsg) type_);
                type_ = subBuilder.buildPartial();
              }
              typeCase_ = 12;
              break;
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 10: {
                if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                  games_ = new java.util.ArrayList<me.ippolitov.fit.snakes.SnakesProto.GameAnnouncement>();
                  mutable_bitField0_ |= 0x00000001;
                }
                games_.add(
                    input.readMessage(me.ippolitov.fit.snakes.SnakesProto.GameAnnouncement.PARSER, extensionRegistry));
                break;
              }
              default: {
                if (!parseUnknownField(
    ...
    private static final long serialVersionUID = 0L;
      ...
      public static final class Builder extends
        ...
        public Builder mergeFrom(
            ...
            com.google.protobuf.ExtensionRegistryLite extensionRegistry)
            throws java.io.IOException {
          me.ippolitov.fit.snakes.SnakesProto.GameMessage.DiscoverMsg parsedMessage = null;
          try {
            parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
          } catch (com.google.protobuf.InvalidProtocolBufferException e) {
            parsedMessage = (me.ippolitov.fit.snakes.SnakesProto.GameMessage.DiscoverMsg) e.getUnfinishedMessage();
            throw e.unwrapIOException();
          } finally {
            if (parsedMessage != null) {
              mergeFrom(parsedMessage);
